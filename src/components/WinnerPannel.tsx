...
const WinnerPannel = () => {
    ...
    if (roundIsCompleted) {
        return <>
            <div className="relative rounded-4xl bg-white/40 backdrop-blur-xl max-w-2xl mx-auto mt-10 z-10">
                <span
                    className="absolute font-bold  font-poetsen -top-6 left-18 sm:-top-10 sm:left-24 text-3xl sm:text-5xl -rotate-3 py-3 px-9 bg-white rounded-2xl text-indigo-400 shadow"
                >
                    ¡WINNER!
                </span>
                <div className=" rounded-4xl border-gradient">
                    <div className="flex items-center justify-center min-h-40 relative">
                        ...
                        <ConfettiExplosion
                            ...
                            width={1600}
                        />
                        <p className="text-4xl md:text-5xl font-extrabold  font-poetsen drop-shadow-2xl mt-9 text-center px-4 py-10">
                            {currentWinner ? <>
            ...
            <div>
                <button
                    onClick={goBack}
                    className="flex items-center gap-2 mx-auto mt-7 px-4 py-2 text-white bg-indigo-500 rounded-lg hover:bg-blue-950 "
                >
    ...
    return (
        ...
        >
            <div className="text-3xl md:text-5xl font-poetsen text-gray-200 text-center px-4">
                {roundIsPaused ?
